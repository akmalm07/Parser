...
int main()
{
	...
	EntireUntockeizedFile fileStr = "This is a test file for the parser section handler";


	EntireTockenizedFile file = tokenize(fileStr, TokenizationSeperationBitFlags::TockeizeWhitespace);
